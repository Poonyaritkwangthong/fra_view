                        ...
                        <tr class="text-[#7d8a99] border-b text-center">
                            ...
                            <td class="p-4">
                                @if ($item->total_score <= 20)
                                    <h1 class="text-[#ff387a]">ระดับความพร้อมน้อย</h1>
                                @elseif ($item->total_score <= 30)
                                    <h1 class="text-[#fcba03]">ระดับความพร้อมปลานกลาง</h1>
                                @elseif ($item->total_score <= 40)
                                    <h1 class="text-[#0ccf4a]">ระดับความพร้อมมาก</h1>
                                @elseif ($item->total_score <= 47)
                                    <h1 class="text-[#38b6ff]">ระดับความพร้อมมากที่สุด</h1>
                                @endif
                            </td>
                        </tr>
                    @endforeach
