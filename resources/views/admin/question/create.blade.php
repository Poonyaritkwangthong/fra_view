...
@section('form_admin')
    <div>
        <div class="border w-[60rem] h-full p-[2rem] rounded-3xl shadow-2xl mx-auto">
            ...
            <form class="text-lg" action="{{ route('question.store') }}" method="POST">
                @csrf <!-- ป้องกัน CSRF (จำเป็นใน Laravel) -->
                <div class="border-b mb-[2rem]">
                    <div class="mb-[1rem]">
                        <label for="question">ตั้งคำถาม</label>
                        <input class="text-[#525456] bg-[#f4f4fc] border-[#a3a0df] border rounded-lg w-full pl-2 p-2" type="text" name="question" id="question" required>
                    </div>
                    <div class="mb-[1rem]">
                        <label>ตั้งประเภทคำถาม</label>
                        <div class="flex gap-[1rem] items-center mt-[1rem]">
                            <div>
                                <input class="bg-[#f4f4fc] border-[#a3a0df] border" type="radio" name="q_type" value="radio" id="q_type_radio" required>
                                <label for="q_type_radio">แบบเลือกได้ตัวเลือกเดียว</label><br>
                            </div>
                            <div>
                                <input class="bg-[#f4f4fc] border-[#a3a0df] border" type="radio" name="q_type" value="checkbox" id="q_type_checkbox">
                    ...
                    <div class="mb-[2rem]">
                        ...
                        <div class="flex gap-[1rem] items-center mt-[1rem]">
                            <div>
                                <input class="bg-[#f4f4fc] border-[#a3a0df] border" type="radio" name="q_status" value="start" id="q_status_start" required>
                                <label class="bg-[#abf7b1] text-[#004a12] p-2 rounded-lg" for="q_status_start">เปิดใช้งาน</label><br>
                            </div>
                            <div>
                                <input class="bg-[#f4f4fc] border-[#a3a0df] border" type="radio" name="q_status" value="stop" id="q_status_stop">
