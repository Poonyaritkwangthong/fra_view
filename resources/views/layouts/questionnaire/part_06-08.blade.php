...
<div class="mt-[2rem] border-b">
    ...
    <div class="pl-16 mt-[1rem] mb-[2rem]">
        <textarea class="text-[#525456] text-lg bg-[#f4f4fc] border-[#a3a0df] p-1 rounded-lg w-full h-[8rem] mb-[2rem] pl-2"
...
<div class="mt-[2rem] border-b">
    ...
    <div class="flex gap-[2rem] items-center">
        <div class="grid grid-rows-2 grid-flow-col gap-4 mt-[1rem] pl-16 mb-[2rem]">
            ...
            <div>
                <input type="radio" name="cause" value="ย้ายที่อยู่" id="" onclick="hideAllFields7()">
