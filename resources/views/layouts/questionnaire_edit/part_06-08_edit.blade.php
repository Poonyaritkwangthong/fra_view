        ...
        <div class="grid grid-rows-2 grid-flow-col gap-4 mt-[1rem] pl-16 mb-[2rem]">
            <div>
                <input type="radio" name="cause" value="8.1 ผู้ใช้บริการสามารถดำรงชีวิตได้อย่างปกติ" id=""
                    onclick="hideAllFields7()" {{ $general_information->termination_of_service->cause == '8.1 ผู้ใช้บริการสามารถดำรงชีวิตได้อย่างปกติ' ? 'checked' : '' }}>
            ...
            <div class="flex gap-4 items-center">
                <div>
                    <input type="radio" name="cause" value="8.2 ส่งต่อไปบริการยังหน่วยงานอื่นๆ" id=""
                        onclick="toggleFields7(true)" {{ $general_information->termination_of_service->cause == '8.2 ส่งต่อไปบริการยังหน่วยงานอื่นๆ' ? 'checked' : '' }}>
            ...
            <div>
                <input type="radio" name="cause" value="8.3 ผู้ใช้บริการถึงเเก่กรรม" id=""
                    onclick="hideAllFields7()" {{ $general_information->termination_of_service->cause == '8.3 ผู้ใช้บริการถึงเเก่กรรม' ? 'checked' : '' }}>
            ...
            <div>
                <input type="radio" name="cause" value="8.4 ผู้ใช้บริการปฏิเสธการบริการ" id=""
                    onclick="hideAllFields7()" {{ $general_information->termination_of_service->cause == '8.4 ผู้ใช้บริการปฏิเสธการบริการ' ? 'checked' : '' }}>
                <label class="text-[#525456] text-lg" for="cause">8.4 ผู้ใช้บริการปฏิเสธการบริการ</label>
            </div>
            <div>
                <input type="radio" name="cause" value="8.5 ย้ายที่อยู่" id="" onclick="hideAllFields7()" {{ $general_information->termination_of_service->cause == '8.5 ย้ายที่อยู่' ? 'checked' : '' }}>
