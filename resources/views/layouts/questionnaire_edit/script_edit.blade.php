<script>
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        const idMap = {"8.2 ส่งต่อไปบริการยังหน่วยงานอื่นๆ": "toggleFields7(true)"};

        // ตรวจสอบว่า selectedCause มีค่าหรือไม่
        if (selectedCause && idMap[selectedCause]) {
            eval(idMap[selectedCause]);  // เรียกใช้ฟังก์ชัน toggleFields7(true)
        }
    });
