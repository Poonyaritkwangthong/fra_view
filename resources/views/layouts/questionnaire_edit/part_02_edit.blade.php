...
<div>
    ...
    <div class="grid grid-rows-5 grid-flow-col gap-[1rem] mt-[1rem] pl-16 mb-[1rem]">
        ...
        <input type="hidden" id="hiddenField" name="facts_target_group_detail" value="{{ $general_information->finding_facts->facts_target_group_detail }}">
        ...
        <div class="flex gap-2 items-center">
            ...
            <label class="text-[#525456] text-lg" for="target_general_patient">6.ผู้พิการ</label>
                ...
                <div id="on-5" style="display: none">
                    <div class="flex gap-2 items-center">
                        ...
                        <div class="flex items-center gap-4">
                            ...
                            <div>
                                <input type="radio" value="ในระบบ" name="source_of_debt" id="source_of_debt"
                            ...
                            <div>
                                <input type="radio" value="นอกระบบ" name="source_of_debt" id="source_of_debt"
                            ...
                            <div>
                                <input type="radio" value="" name="source_of_debt">
                                <label class="text-[#525456] text-lg" for="cancel_debt_out_system">ยกเลิกการเลือก</label>
                            </div>
                        </div>
                    </div>
                </div>
