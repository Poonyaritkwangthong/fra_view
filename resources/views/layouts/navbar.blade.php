<aside id="default-sidebar"
    ...
    <div class="h-full px-3 py-4 overflow-y-auto bg-white">
        <ul class="space-y-2 font-medium">
            ...
            <p class="text-[#00609e] text-lg font-bold mt-2 pl-4">กราฟสรุปผล</p>
            <li class="mt-[4rem]">
            ...
            <p class="text-[#00609e] text-lg font-bold mt-2 pl-4">เเบบประเมิน</p>
            <li>
            ...
            <p class="text-[#00609e] text-lg font-bold mt-2 pl-4">ข้อมูลขอความอนุเคราะห์</p>
            <li>
                <a href="{{ url('/admin/general_information') }}"
                    class="flex items-center p-2 text-gray-700 rounded-lg bg-[#f5f5f9] hover:bg-[#dcdcde] mb-4">
            ...
            <li>
                <a href="#"
                    class="flex items-center p-2 text-gray-700 rounded-lg bg-[#f5f5f9] hover:bg-[#8fd3ff] hover:text-[#00609e] mt-4">
